...
interface TraitBarProps {
  trait: string;
  value: number; // This should be a decimal between 0-1
  label: string;
}

const TraitBar: React.FC<TraitBarProps> = ({ trait, value, label }) => {
  // Calculate percentage for the visual bar (values come in as decimals 0-1)
    ...
    <div className="card results-card">
      ...
      {userFeedback === null && (
        <div className="feedback-section">
          <h3 className="feedback-title">Did we read your mind correctly?</h3>
      ...
      <div className="results-footer">
        * Results may vary. Our AI is still learning the complexity of human
        personalities.
      </div>
    </div>
  );
